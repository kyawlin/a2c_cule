...
def add_global_parser_options(parser):
    parser.add_argument('--ale-start-steps', type=int, default=100, help='Number of steps used to initialize ALEs (default: 400)')
    ...
    parser.add_argument('--lr', type=float, default=0.0006, help='learning rate (default: 0.00065)')
    ...
    parser.add_argument('--num-ales', type=int, default=1200, help='number of environments (default: 16)')
